...
def get_ip_data():
    ...
    input_location = input("What is your location? ")
    input_user =input("Please enter valid user name? ")
    d = {"IP": input_ip, "driver": input_driver, "location": input_location, "user": input_user}
    return d
